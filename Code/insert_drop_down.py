...
def on_table_selected(event, table_var):
    ...
    insert.open_insert_window(selected_table)


def drop_down():
    # Create a Tkinter window
    root = tk.Tk()
    root.title("Select table to perform insertion")
    ...
    show_button = tk.Button(root, text="Insert Data", command=lambda:on_table_selected("<<ComboboxSelected>>", table_var))
    show_button.pack()
