...
def on_table_selected(event, table_var):
    ...
    delete.open_delete_window(selected_table)


def drop_down():
    # Create a Tkinter window
    root = tk.Tk()
    root.title("Select table to perform deletion")
    ...
    show_button = tk.Button(root, text="Delete Data", command=lambda:on_table_selected("<<ComboboxSelected>>", table_var))
    show_button.pack()
